...
public class PauseScreen extends Screen
{
    ...
    public void init() {
        ...
        this.buttons.add(new Button(3, this.width / 2 - 100, this.height / 4 + 96, 97, 20, "Back to game"));
        this.buttons.add(new Button(4, this.width / 2 - 0, this.height / 4 + 96, 100, 20, "Exit"));
    }
